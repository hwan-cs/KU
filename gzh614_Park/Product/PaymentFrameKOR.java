...
public class PaymentFrameKOR extends JFrame 
{
	...
	public PaymentFrameKOR(final int row, final int col) 
	{
		int [][] intOnly = DateFrame.objToInt(GolfCalendarKOR.formattedCalendarKOR);
		final int dateInt = intOnly[row][col] -1;
		final DateCal[] forPayment = GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate();
		...
		final JButton cal = new JButton("계산");
		System.out.println("MONTH IS: " + forPayment[dateInt].getMm());
		if(GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().size()==1)
		{
		...
		else if (GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().size()==2)
		{
		...
		else if (GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().size()==3)
		{
		...
		else if (GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().size()==4)
		{
		...
		else if (GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().size()==5)
		{
		...
		else if (GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().size()==6)
		{
			pFrame.setSize(800, 660);
			contentPane = new JPanel();
			contentPane.setBounds(0,0,800,638);
		...
		if (new GregorianCalendar(GolfCalendar.cbModelYear.get(GolfCalendar.cbYear.getSelectedIndex())
				, GolfCalendar.cbModelMonth.get(GolfCalendar.cbMonth.getSelectedIndex()) -1, 
				GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).month[GolfCalendar.cbMonth.getSelectedIndex()].date[dateInt-1].getDd()).get(Calendar.DAY_OF_WEEK) > Calendar.THURSDAY)
		{
			isWeek = true;
		}
		else
		...
		System.out.println("isWeek is" +isWeek);
			...
			cal.addMouseListener(new MouseAdapter() 
			{
				...
				public void mouseClicked(MouseEvent arg0) 
				{
					...
					for (int i = 0; i<GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).getMonth()[GolfCalendar.cbMonth.getSelectedIndex()].getDate()[dateInt].getGs().getGroup().size(); i++)
					{
						...
						System.out.println("MEMBER " + GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).month[(GolfCalendar.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().get(i).getMember());
						System.out.println("CADDIE " + GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).month[(GolfCalendar.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().get(i).getCaddie());
						System.out.println("GC " + GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).month[(GolfCalendar.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().get(i).getGolfCart());
						if(GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).month[(GolfCalendar.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().get(i).getMember() != null)
						{
								...
								members.size() > 0 && nonMembers.size() >0 && isPromo == 3)
						{
							while(nonMembers.size() > 0 && members.size()> 0)
							{
								...
								{
									if (GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).getMonth()[GolfCalendar.cbMonth.getSelectedIndex()].getDate()[dateInt].getGs().getGroup().get(i).getName().equals
											(nonMembers.get(t).getName()))
									{
										System.out.println(nonMembers.get(t).getName());
										if(GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).month[(GolfCalendar.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getNumHoles() == 9)
										{
											if(isWeek)
											{
						...
						if(GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).month[(GolfCalendar.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGc().getGolfCourse().equals("DLF") && isPromo == 4
								&& GolfCalendar.yy.get(GolfCalendar.cbYear.getSelectedIndex()).getMonth()[GolfCalendar.cbMonth.getSelectedIndex()].getDate()[dateInt].getGs().getGroup().get(i).getMember() == false)
						{
							total = 3950.0;
	...
	public void refreshPayment(int row, int col, JLabel [] arr)
	{
		...
		for(int i = 0; i<GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().size(); i++)
		{
			if (i >= 0 && i < 4)
			{
				...
				JLabel lblMember = new JLabel("멤버: ");
				...
				chckbxMember.addItemListener(new ItemListener() 
				{
					public void itemStateChanged(ItemEvent arg0) 
					{
						...
						{
							GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].date[dateInt].getGs().getGroup().get(count).setMember(true);
						}
						else if(chckbxMember.isSelected() == false)
						{
							GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].date[dateInt].getGs().getGroup().get(count).setMember(false);
						}
					}
				});
				...
				JLabel lblCaddie = new JLabel("캐디: ");
				...
				chckbxCaddie.addItemListener(new ItemListener() 
				{
					public void itemStateChanged(ItemEvent arg0) 
					{
						...
						{
							GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].date[dateInt].getGs().getGroup().get(count).setCaddie(true);
						}
						else if(chckbxCaddie.isSelected() == false)
						{
							GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].date[dateInt].getGs().getGroup().get(count).setCaddie(false);
						}
					}
				});
				contentPane.add(chckbxCaddie);
				JLabel lblGolfCart = new JLabel("골프 카트: ");
				...
				chckbxGolfCart.addActionListener(new ActionListener() 
				{
					...
					public void actionPerformed(ActionEvent e) 
					{
						...
						{
							GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].date[dateInt].getGs().getGroup().get(count).setGolfCart(true);
						}
						else if(chckbxGolfCart.isSelected() == false)
						{
							GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].date[dateInt].getGs().getGroup().get(count).setGolfCart(false);
						}  
					}
				});
				...
				if(GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().get(i).getPrice() != 0)
				{
					lblPriceFor.setLineWrap(true);
					lblPriceFor.setWrapStyleWord(true);
					lblPriceFor.setBackground(Color.LIGHT_GRAY);
					lblPriceFor.setText(GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().get(i).getName()+ "의 지불 금액: "
						+"\n" + GolfCalendar.yy.get(GolfCalendarKOR.cbYear.getSelectedIndex()).month[(GolfCalendarKOR.cbMonth.getSelectedIndex())].getDate()[dateInt].getGs().getGroup().get(i).getPrice());
				}
				else
				{
					if(arr[0] != null)
